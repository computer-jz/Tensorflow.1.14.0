...
EVAL_DATA = 'data/simple-examples/data/ptb.valid'
TEST_DATA = 'data/simple-examples/data/ptb.test'
HIDDEN_SIZE = 300
# 深层循环网络中LSTM的层数
NUM_LAYERS = 2
VOCAB_SIZE = 10000
...
class PTBModel(object):
    def __init__(self,is_training,batch_size,num_steps):
        ...
        # 定义输出列表,在这里先将不同时刻LSTM结构的输出收集起来,再一起提供给 softmax层
        outputs = []
...
def make_batches(id_list, batch_size, num_step):
    ...
    print("train_lable_shape:",np.array(label_batches).shape)
